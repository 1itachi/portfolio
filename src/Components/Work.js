        ...
        return(
            ...
            <div className="row">
              <div class="card col-sm-6 card-background" >
                <img class="card-img-top card-image" src={baboon} alt="Card image cap"/>
                <div class="card-body">
                ...
                <a class="github" href="http://github.com/itachi1994/ImageProcessingApplication/" target="_blank"><i class="fab fa-github fa-2x float-right"></i></a>
                </div>
                </div>

                <div class="card col-sm-6 card-background" >
                <a href="https://frontend-bookbar.herokuapp.com/" target="_blank"><img class="card-img-top card-image-book" src={bookbar} alt="Card image cap"/></a>
                <div class="card-body">
                ...
                <p class="para-style card-text mb-4">Collaborated on building a FullStack application. A user can register and login as either a buyer or a seller. A buyer can place an order on the books currently being sold by a seller.
                 ...
                 <p></p>
                <a class="github" href="https://github.com/itachi1994/BookBar-frontend" target="_blank"><i class="fab fa-github fa-2x float-right"></i></a>
                </div>
                </div>


                <div class="card col-sm-6 card-background" >
                <a href="https://www.youracclaim.com/badges/a4f99f6f-9e01-43ea-90b7-a783a3be1b1f/linked_in_profile" target="_blank"><img class="card-img-top card-image-book" src={developer} alt="Card image cap"/></a>
                <div class="card-body">
                ...
                <div class="card col-sm-6 card-background" >
                <a href="https://www.youracclaim.com/badges/54574a16-bc9b-41e8-8e26-93b50ca3cd59?source=linked_in_profile" target="_blank"><img class="card-img-top card-image-book" src={solution} alt="Card image cap"/></a>
                <div class="card-body">
