    ...
    return (
      <div className="row mt-5 animated animatedFadeInUp fadeInUp" id="first">
        ...
        <div className="col-sm-6 mt-3 p-0 mb-4 intro-detail">
          ...
          <p1>
            I am a Master of Science in Computer Science (MSCS) candidate at
            Northeastern University, Boston. I enjoy building reactive
            applications. I am also a cloud person, AWS Developer & Solution
        ...
        <div className="col-sm-6 mt-5">
          <figure>
            <embed src="https://wakatime.com/share/@itachi1994/6eff178a-28b9-48bc-a510-35a596f7ac22.svg"></embed>
          </figure>
        </div>
        {/* </Reveal> */}
      </div>
