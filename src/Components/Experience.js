...
export default class Experience extends React.Component {
  ...
  render() {
    ...
    return(
        ...
        <button className="button-style border border-info active p-2 mr-2" onClick={this.philipsActive}>Philips</button>
        <button className="button-style border border-info p-2 mr-2" onClick={this.slalomActive}>Slalom Build</button>
